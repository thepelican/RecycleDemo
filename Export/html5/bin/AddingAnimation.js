...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("assets/nme.png",loader);
...
ApplicationMain.getAsset = function(inName) {
	if(inName == "assets/nme.png") return nme.installer.Assets.getBitmapData("assets/nme.png");
	return null;
}
...
var Main = function() {
	...
	var background = new browser.display.Sprite();
	background.get_graphics().beginFill(16711680,1);
	background.get_graphics().drawRect(0,0,nme.Lib.get_current().get_stage().get_stageWidth(),nme.Lib.get_current().get_stage().get_stageHeight());
...
com.eclecticdesignstudio.motion.easing.Expo.__properties__ = {get_easeOut:"get_easeOut",get_easeInOut:"get_easeInOut",get_easeIn:"get_easeIn"}
...
com.eclecticdesignstudio.motion.Actuate.createInstance = function(actuator,target,duration,properties) {
	...
	if(actuator == com.eclecticdesignstudio.motion.actuators.MotionPathActuator) return new com.eclecticdesignstudio.motion.actuators.MotionPathActuator(target,duration,properties);
	return null;
}
...
com.eclecticdesignstudio.motion.Actuate.motionPath = function(target,duration,properties,overwrite) {
	if(overwrite == null) overwrite = true;
	return com.eclecticdesignstudio.motion.Actuate.tween(target,duration,properties,overwrite,com.eclecticdesignstudio.motion.actuators.MotionPathActuator);
}
com.eclecticdesignstudio.motion.Actuate.pause = function(target) {
	if(js.Boot.__instanceof(target,com.eclecticdesignstudio.motion.actuators.GenericActuator)) (js.Boot.__cast(target , com.eclecticdesignstudio.motion.actuators.GenericActuator)).pause(); else {
...
com.eclecticdesignstudio.motion.Actuate.resume = function(target) {
	if(js.Boot.__instanceof(target,com.eclecticdesignstudio.motion.actuators.GenericActuator)) (js.Boot.__cast(target , com.eclecticdesignstudio.motion.actuators.GenericActuator)).resume(); else {
		var library = com.eclecticdesignstudio.motion.Actuate.getLibrary(target);
		var _g = 0;
		while(_g < library.length) {
			var actuator = library[_g];
...
$hxClasses["com.eclecticdesignstudio.motion._Actuate.EffectsOptions"] = com.eclecticdesignstudio.motion._Actuate.EffectsOptions;
...
$hxClasses["com.eclecticdesignstudio.motion._Actuate.TransformOptions"] = com.eclecticdesignstudio.motion._Actuate.TransformOptions;
...
$hxClasses["com.eclecticdesignstudio.motion._Actuate.TweenTimer"] = com.eclecticdesignstudio.motion._Actuate.TweenTimer;
...
com.eclecticdesignstudio.motion.MotionPath = function() {
	this._x = new com.eclecticdesignstudio.motion.ComponentPath();
	this._y = new com.eclecticdesignstudio.motion.ComponentPath();
};
...
com.eclecticdesignstudio.motion.MotionPath.prototype = {
	...
	,line: function(x,y,strength) {
		if(strength == null) strength = 1;
		this._x.addPath(new com.eclecticdesignstudio.motion.LinearPath(x,strength));
		this._y.addPath(new com.eclecticdesignstudio.motion.LinearPath(y,strength));
		return this;
	}
	,bezier: function(x,y,controlX,controlY,strength) {
		if(strength == null) strength = 1;
		this._x.addPath(new com.eclecticdesignstudio.motion.BezierPath(x,controlX,strength));
		this._y.addPath(new com.eclecticdesignstudio.motion.BezierPath(y,controlY,strength));
		return this;
	}
	,_y: null
	,_x: null
...
com.eclecticdesignstudio.motion.BezierPath = function(end,control,strength) {
	this.end = end;
...
com.eclecticdesignstudio.motion.LinearPath = function(end,strength) {
	com.eclecticdesignstudio.motion.BezierPath.call(this,end,0,strength);
};
...
com.eclecticdesignstudio.motion.actuators.FilterActuator = function(target,duration,properties) {
	...
	if(js.Boot.__instanceof(properties.filter,Class)) {
		...
		var _g = 0, _g1 = (js.Boot.__cast(target , browser.display.DisplayObject)).get_filters();
		while(_g < _g1.length) {
			var filter = _g1[_g];
			++_g;
		...
		this.filter = (js.Boot.__cast(target , browser.display.DisplayObject)).get_filters()[this.filterIndex];
	}
};
...
com.eclecticdesignstudio.motion.actuators.MotionPathActuator = function(target,duration,properties) {
	com.eclecticdesignstudio.motion.actuators.SimpleActuator.call(this,target,duration,properties);
};
...
com.eclecticdesignstudio.motion.easing.Elastic = function() { }
$hxClasses["com.eclecticdesignstudio.motion.easing.Elastic"] = com.eclecticdesignstudio.motion.easing.Elastic;
com.eclecticdesignstudio.motion.easing.Elastic.__name__ = ["com","eclecticdesignstudio","motion","easing","Elastic"];
com.eclecticdesignstudio.motion.easing.Elastic.__properties__ = {get_easeOut:"getEaseOut",get_easeInOut:"getEaseInOut",get_easeIn:"getEaseIn"}
com.eclecticdesignstudio.motion.easing.Elastic.easeIn = null;
com.eclecticdesignstudio.motion.easing.Elastic.easeInOut = null;
com.eclecticdesignstudio.motion.easing.Elastic.easeOut = null;
com.eclecticdesignstudio.motion.easing.Elastic.getEaseIn = function() {
	return new com.eclecticdesignstudio.motion.easing.ElasticEaseIn(0.1,0.4);
}
com.eclecticdesignstudio.motion.easing.Elastic.getEaseInOut = function() {
	return new com.eclecticdesignstudio.motion.easing.ElasticEaseInOut(0.1,0.4);
}
com.eclecticdesignstudio.motion.easing.Elastic.getEaseOut = function() {
	return new com.eclecticdesignstudio.motion.easing.ElasticEaseOut(0.1,0.4);
}
com.eclecticdesignstudio.motion.easing.ElasticEaseIn = function(a,p) {
	this.a = a;
	this.p = p;
};
$hxClasses["com.eclecticdesignstudio.motion.easing.ElasticEaseIn"] = com.eclecticdesignstudio.motion.easing.ElasticEaseIn;
com.eclecticdesignstudio.motion.easing.ElasticEaseIn.__name__ = ["com","eclecticdesignstudio","motion","easing","ElasticEaseIn"];
com.eclecticdesignstudio.motion.easing.ElasticEaseIn.__interfaces__ = [com.eclecticdesignstudio.motion.easing.IEasing];
com.eclecticdesignstudio.motion.easing.ElasticEaseIn.prototype = {
	ease: function(t,b,c,d) {
		if(t == 0) return b;
		if((t /= d) == 1) return b + c;
		var s;
	...
	,p: null
	,a: null
	,__class__: com.eclecticdesignstudio.motion.easing.ElasticEaseIn
}
com.eclecticdesignstudio.motion.easing.ElasticEaseInOut = function(a,p) {
	this.a = a;
	this.p = p;
};
$hxClasses["com.eclecticdesignstudio.motion.easing.ElasticEaseInOut"] = com.eclecticdesignstudio.motion.easing.ElasticEaseInOut;
com.eclecticdesignstudio.motion.easing.ElasticEaseInOut.__name__ = ["com","eclecticdesignstudio","motion","easing","ElasticEaseInOut"];
com.eclecticdesignstudio.motion.easing.ElasticEaseInOut.__interfaces__ = [com.eclecticdesignstudio.motion.easing.IEasing];
com.eclecticdesignstudio.motion.easing.ElasticEaseInOut.prototype = {
	ease: function(t,b,c,d) {
		if(t == 0) return b;
	...
	,p: null
	,a: null
	,__class__: com.eclecticdesignstudio.motion.easing.ElasticEaseInOut
}
com.eclecticdesignstudio.motion.easing.ElasticEaseOut = function(a,p) {
	this.a = a;
	this.p = p;
};
$hxClasses["com.eclecticdesignstudio.motion.easing.ElasticEaseOut"] = com.eclecticdesignstudio.motion.easing.ElasticEaseOut;
com.eclecticdesignstudio.motion.easing.ElasticEaseOut.__name__ = ["com","eclecticdesignstudio","motion","easing","ElasticEaseOut"];
com.eclecticdesignstudio.motion.easing.ElasticEaseOut.__interfaces__ = [com.eclecticdesignstudio.motion.easing.IEasing];
com.eclecticdesignstudio.motion.easing.ElasticEaseOut.prototype = {
	ease: function(t,b,c,d) {
		if(t == 0) return b;
		if((t /= d) == 1) return b + c;
		var s;
	...
	,p: null
	,a: null
	,__class__: com.eclecticdesignstudio.motion.easing.ElasticEaseOut
}
...
nme.installer.Assets.initialize = function() {
	if(!nme.installer.Assets.initialized) {
		nme.installer.Assets.resourceNames.set("assets/nme.png","assets/nme.png");
		nme.installer.Assets.resourceTypes.set("assets/nme.png","image");
...
nme.installer.Assets.getBitmapData = function(id,useCache) {
	...
	if(nme.installer.Assets.resourceNames.exists(id) && nme.installer.Assets.resourceTypes.exists(id) && nme.installer.Assets.resourceTypes.get(id).toLowerCase() == "image") {
		...
		} else haxe.Log.trace("[nme.Assets] There is no asset library named \"" + libraryName + "\"",{ fileName : "Assets.hx", lineNumber : 129, className : "nme.installer.Assets", methodName : "getBitmapData"});
	} else haxe.Log.trace("[nme.Assets] There is no BitmapData asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 135, className : "nme.installer.Assets", methodName : "getBitmapData"});
	return null;
}
nme.installer.Assets.getBytes = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no String or ByteArray asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 154, className : "nme.installer.Assets", methodName : "getBytes"});
	return null;
}
nme.installer.Assets.getFont = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no Font asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 175, className : "nme.installer.Assets", methodName : "getFont"});
	return null;
}
nme.installer.Assets.getMovieClip = function(id) {
	...
	var symbolName = HxOverrides.substr(id,id.indexOf(":") + 1,null);
	if(nme.installer.Assets.libraryTypes.exists(libraryName)) {
	} else haxe.Log.trace("[nme.Assets] There is no asset library named \"" + libraryName + "\"",{ fileName : "Assets.hx", lineNumber : 227, className : "nme.installer.Assets", methodName : "getMovieClip"});
	return null;
}
...
nme.installer.Assets.getSound = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no Sound asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 263, className : "nme.installer.Assets", methodName : "getSound"});
	return null;
}
