...
HX_DECLARE_CLASS2(motion,_Actuate,ObjectHash)
...
class Actuate_obj : public hx::Object{
	...
	public:
		...
		static ::motion::easing::IEasing defaultEase; /* REM */ 
		static ::motion::_Actuate::ObjectHash targetLibraries; /* REM */ 
		...
		static ::motion::_Actuate::EffectsOptions effects( ::native::display::DisplayObject target,Float duration,hx::Null< bool >  overwrite);
		static Dynamic effects_dyn();

		static Array< ::motion::actuators::GenericActuator > getLibrary( Dynamic target);
