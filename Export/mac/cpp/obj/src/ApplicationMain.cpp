...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(15)
		::nme::Lib_obj::setPackage(HX_CSTRING("NME"),HX_CSTRING("AddingAnimation"),HX_CSTRING("io.nme.samples.addinganimation"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(39)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Adding Animation"),null());
	}
return null();
}
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_STACK_LINE(107)
	if (((inName == HX_CSTRING("assets/nme.png")))){
		HX_STACK_LINE(108)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/nme.png"),null());
	}
	HX_STACK_LINE(115)
	return null();
}
