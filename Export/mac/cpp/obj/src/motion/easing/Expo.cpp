...
::motion::easing::IEasing Expo_obj::easeIn;

::motion::easing::IEasing Expo_obj::easeInOut;

::motion::easing::IEasing Expo_obj::easeOut;
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("motion.easing.Expo"), hx::TCanCast< Expo_obj> ,sStaticFields,sMemberFields,
