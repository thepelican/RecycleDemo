...
{
HX_STACK_PUSH("ObjectHash::new","motion/Actuate.hx",560);
{
	HX_STACK_LINE(560)
...
{
		HX_STACK_PUSH("ObjectHash::set","motion/Actuate.hx",674);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ObjectHash::remove","motion/Actuate.hx",659);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
		HX_STACK_LINE(659)
...
Dynamic ObjectHash_obj::iterator( ){
	HX_STACK_PUSH("ObjectHash::iterator","motion/Actuate.hx",636);
	HX_STACK_THIS(this);
	HX_STACK_LINE(636)
...
int ObjectHash_obj::getID( Dynamic key){
	HX_STACK_PUSH("ObjectHash::getID","motion/Actuate.hx",605);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(605)
...
Dynamic ObjectHash_obj::get( Dynamic key){
	HX_STACK_PUSH("ObjectHash::get","motion/Actuate.hx",590);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(590)
...
bool ObjectHash_obj::exists( Dynamic key){
	HX_STACK_PUSH("ObjectHash::exists","motion/Actuate.hx",575);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(575)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("motion._Actuate.ObjectHash"), hx::TCanCast< ObjectHash_obj> ,sStaticFields,sMemberFields,
