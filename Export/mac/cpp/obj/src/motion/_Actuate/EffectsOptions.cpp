...
{
HX_STACK_PUSH("EffectsOptions::new","motion/Actuate.hx",422);
{
	HX_STACK_LINE(424)
	this->target = target;
	HX_STACK_LINE(425)
...
::motion::actuators::IGenericActuator EffectsOptions_obj::filter( Dynamic reference,Dynamic properties){
	HX_STACK_PUSH("EffectsOptions::filter","motion/Actuate.hx",437);
	HX_STACK_THIS(this);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("motion._Actuate.EffectsOptions"), hx::TCanCast< EffectsOptions_obj> ,sStaticFields,sMemberFields,
