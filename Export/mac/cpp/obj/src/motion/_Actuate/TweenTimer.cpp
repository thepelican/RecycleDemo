...
{
HX_STACK_PUSH("TweenTimer::new","motion/Actuate.hx",526);
{
	HX_STACK_LINE(526)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("motion._Actuate.TweenTimer"), hx::TCanCast< TweenTimer_obj> ,sStaticFields,sMemberFields,
