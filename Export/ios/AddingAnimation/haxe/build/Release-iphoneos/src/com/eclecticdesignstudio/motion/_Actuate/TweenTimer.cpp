...
{
HX_STACK_PUSH("TweenTimer::new","com/eclecticdesignstudio/motion/Actuate.hx",551);
{
	HX_STACK_LINE(551)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion._Actuate.TweenTimer"), hx::TCanCast< TweenTimer_obj> ,sStaticFields,sMemberFields,
