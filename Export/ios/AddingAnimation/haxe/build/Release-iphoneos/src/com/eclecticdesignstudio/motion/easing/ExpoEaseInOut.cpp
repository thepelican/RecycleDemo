...
{
HX_STACK_PUSH("ExpoEaseInOut::new","com/eclecticdesignstudio/motion/easing/Expo.hx",73);
{
}
;
	return null();
...
hx::Object *ExpoEaseInOut_obj::__ToInterface(const type_info &inType) {
...
Float ExpoEaseInOut_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("ExpoEaseInOut::ease","com/eclecticdesignstudio/motion/easing/Expo.hx",92);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float ExpoEaseInOut_obj::calculate( Float k){
	HX_STACK_PUSH("ExpoEaseInOut::calculate","com/eclecticdesignstudio/motion/easing/Expo.hx",80);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(82)
	if (((k == (int)0))){
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.ExpoEaseInOut"), hx::TCanCast< ExpoEaseInOut_obj> ,sStaticFields,sMemberFields,
