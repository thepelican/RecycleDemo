...
{
HX_STACK_PUSH("LinearPath::new","com/eclecticdesignstudio/motion/MotionPath.hx",214);
{
	HX_STACK_LINE(214)
...
Float LinearPath_obj::calculate( Float start,Float k){
	HX_STACK_PUSH("LinearPath::calculate","com/eclecticdesignstudio/motion/MotionPath.hx",221);
	HX_STACK_THIS(this);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.LinearPath"), hx::TCanCast< LinearPath_obj> ,sStaticFields,sMemberFields,
