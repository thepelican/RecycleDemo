...
{
HX_STACK_PUSH("BezierPath::new","com/eclecticdesignstudio/motion/MotionPath.hx",192);
{
	HX_STACK_LINE(194)
	this->end = end;
	HX_STACK_LINE(195)
...
Float BezierPath_obj::calculate( Float start,Float k){
	HX_STACK_PUSH("BezierPath::calculate","com/eclecticdesignstudio/motion/MotionPath.hx",201);
	HX_STACK_THIS(this);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.BezierPath"), hx::TCanCast< BezierPath_obj> ,sStaticFields,sMemberFields,
