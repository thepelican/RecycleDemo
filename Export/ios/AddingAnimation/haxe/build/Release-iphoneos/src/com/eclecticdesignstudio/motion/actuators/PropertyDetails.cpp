...
{
HX_STACK_PUSH("PropertyDetails::new","com/eclecticdesignstudio/motion/actuators/PropertyDetails.hx",19);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.actuators.PropertyDetails"), hx::TCanCast< PropertyDetails_obj> ,sStaticFields,sMemberFields,
