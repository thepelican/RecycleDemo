...
{
HX_STACK_PUSH("ExpoEaseOut::new","com/eclecticdesignstudio/motion/easing/Expo.hx",114);
{
}
;
	return null();
...
hx::Object *ExpoEaseOut_obj::__ToInterface(const type_info &inType) {
...
Float ExpoEaseOut_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("ExpoEaseOut::ease","com/eclecticdesignstudio/motion/easing/Expo.hx",128);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float ExpoEaseOut_obj::calculate( Float k){
	HX_STACK_PUSH("ExpoEaseOut::calculate","com/eclecticdesignstudio/motion/easing/Expo.hx",121);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(121)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.ExpoEaseOut"), hx::TCanCast< ExpoEaseOut_obj> ,sStaticFields,sMemberFields,
