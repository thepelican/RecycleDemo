...
{
HX_STACK_PUSH("ExpoEaseIn::new","com/eclecticdesignstudio/motion/easing/Expo.hx",46);
{
}
;
	return null();
...
hx::Object *ExpoEaseIn_obj::__ToInterface(const type_info &inType) {
...
Float ExpoEaseIn_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("ExpoEaseIn::ease","com/eclecticdesignstudio/motion/easing/Expo.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float ExpoEaseIn_obj::calculate( Float k){
	HX_STACK_PUSH("ExpoEaseIn::calculate","com/eclecticdesignstudio/motion/easing/Expo.hx",53);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(53)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.ExpoEaseIn"), hx::TCanCast< ExpoEaseIn_obj> ,sStaticFields,sMemberFields,
