...
{
HX_STACK_PUSH("ElasticEaseOut::new","com/eclecticdesignstudio/motion/easing/Elastic.hx",163);
{
	HX_STACK_LINE(165)
	this->a = a;
	HX_STACK_LINE(166)
...
Float ElasticEaseOut_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("ElasticEaseOut::ease","com/eclecticdesignstudio/motion/easing/Elastic.hx",182);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float ElasticEaseOut_obj::calculate( Float k){
	HX_STACK_PUSH("ElasticEaseOut::calculate","com/eclecticdesignstudio/motion/easing/Elastic.hx",171);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(173)
	if (((k == (int)0))){
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.ElasticEaseOut"), hx::TCanCast< ElasticEaseOut_obj> ,sStaticFields,sMemberFields,
