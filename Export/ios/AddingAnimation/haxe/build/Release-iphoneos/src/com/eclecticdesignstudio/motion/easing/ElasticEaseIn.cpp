...
{
HX_STACK_PUSH("ElasticEaseIn::new","com/eclecticdesignstudio/motion/easing/Elastic.hx",51);
{
	HX_STACK_LINE(53)
	this->a = a;
	HX_STACK_LINE(54)
...
Float ElasticEaseIn_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("ElasticEaseIn::ease","com/eclecticdesignstudio/motion/easing/Elastic.hx",70);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float ElasticEaseIn_obj::calculate( Float k){
	HX_STACK_PUSH("ElasticEaseIn::calculate","com/eclecticdesignstudio/motion/easing/Elastic.hx",59);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(61)
	if (((k == (int)0))){
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.ElasticEaseIn"), hx::TCanCast< ElasticEaseIn_obj> ,sStaticFields,sMemberFields,
