...
{
HX_STACK_PUSH("MotionPathActuator::new","com/eclecticdesignstudio/motion/actuators/MotionPathActuator.hx",13);
{
	HX_STACK_LINE(13)
...
{
		HX_STACK_PUSH("MotionPathActuator::update","com/eclecticdesignstudio/motion/actuators/MotionPathActuator.hx",92);
		HX_STACK_THIS(this);
		HX_STACK_ARG(currentTime,"currentTime");
		HX_STACK_LINE(92)
		if ((!(this->paused))){
			HX_STACK_LINE(96)
			::com::eclecticdesignstudio::motion::actuators::PropertyPathDetails details;		HX_STACK_VAR(details,"details");
			HX_STACK_LINE(97)
			...
			if ((!(this->special))){
				...
				HX_STACK_LINE(117)
				{
					...
					Array< ::com::eclecticdesignstudio::motion::actuators::PropertyDetails > _g1 = this->propertyDetails;		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(117)
					while(((_g < _g1->length))){
						HX_STACK_LINE(117)
						::com::eclecticdesignstudio::motion::actuators::PropertyDetails details1 = _g1->__get(_g);		HX_STACK_VAR(details1,"details1");
						HX_STACK_LINE(117)
						++(_g);
						HX_STACK_LINE(119)
						if ((details1->isField)){
							...
							if (((o != null()))){
								HX_STACK_LINE(121)
								o->__SetField(details1->propertyName,(hx::TCast< com::eclecticdesignstudio::motion::actuators::PropertyPathDetails >::cast(details1))->path->calculate(easing),false);
							}
						}
						else{
							HX_STACK_LINE(126)
							...
							if (((o != null()))){
								HX_STACK_LINE(126)
								o->__SetField(details1->propertyName,(hx::TCast< com::eclecticdesignstudio::motion::actuators::PropertyPathDetails >::cast(details1))->path->calculate(easing),true);
							}
						}
					}
				}
					...
					while(((_g < _g1->length))){
						...
						if ((!(this->_snapping))){
							...
							if ((details1->isField)){
								...
								if (((o != null()))){
									HX_STACK_LINE(167)
									o->__SetField(details1->propertyName,::Math_obj::round((hx::TCast< com::eclecticdesignstudio::motion::actuators::PropertyPathDetails >::cast(details1))->path->calculate(easing)),false);
								}
							}
							else{
								HX_STACK_LINE(172)
								...
								if (((o != null()))){
									HX_STACK_LINE(172)
									o->__SetField(details1->propertyName,::Math_obj::round((hx::TCast< com::eclecticdesignstudio::motion::actuators::PropertyPathDetails >::cast(details1))->path->calculate(easing)),true);
								}
							}
						}
					}
...
{
		HX_STACK_PUSH("MotionPathActuator::initialize","com/eclecticdesignstudio/motion/actuators/MotionPathActuator.hx",47);
		HX_STACK_THIS(this);
		HX_STACK_LINE(49)
		::com::eclecticdesignstudio::motion::actuators::PropertyPathDetails details;		HX_STACK_VAR(details,"details");
		HX_STACK_LINE(50)
		::com::eclecticdesignstudio::motion::IComponentPath path;		HX_STACK_VAR(path,"path");
		HX_STACK_LINE(52)
		{
			HX_STACK_LINE(52)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			...
			while(((_g < _g1->length))){
				...
				++(_g);
				HX_STACK_LINE(54)
				path = hx::TCast< com::eclecticdesignstudio::motion::IComponentPath >::cast(::Reflect_obj::field(this->properties,propertyName));
				HX_STACK_LINE(56)
				if (((path != null()))){
					HX_STACK_LINE(58)
					...
					if ((::Reflect_obj::hasField(this->target,propertyName))){
						...
						struct _Function_5_1{
							inline static Dynamic Block( ::com::eclecticdesignstudio::motion::actuators::MotionPathActuator_obj *__this,::String &propertyName){
								HX_STACK_PUSH("*::closure","com/eclecticdesignstudio/motion/actuators/MotionPathActuator.hx",69);
								{
									HX_STACK_LINE(69)
					...
					HX_STACK_LINE(79)
					details = ::com::eclecticdesignstudio::motion::actuators::PropertyPathDetails_obj::__new(this->target,propertyName,path,isField);
					HX_STACK_LINE(80)
...
{
		HX_STACK_PUSH("MotionPathActuator::apply","com/eclecticdesignstudio/motion/actuators/MotionPathActuator.hx",20);
		HX_STACK_THIS(this);
		HX_STACK_LINE(22)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		Array< ::String > _g1 = ::Reflect_obj::fields(this->properties);		HX_STACK_VAR(_g1,"_g1");
		...
		while(((_g < _g1->length))){
			...
			if ((::Reflect_obj::hasField(this->target,propertyName))){
				...
				if (((o != null()))){
					HX_STACK_LINE(28)
					o->__SetField(propertyName,(hx::TCast< com::eclecticdesignstudio::motion::IComponentPath >::cast(::Reflect_obj::field(this->properties,propertyName)))->__Field(HX_CSTRING("get_end"),true)(),false);
				}
			}
			else{
				HX_STACK_LINE(32)
				...
				if (((o != null()))){
					HX_STACK_LINE(32)
					o->__SetField(propertyName,(hx::TCast< com::eclecticdesignstudio::motion::IComponentPath >::cast(::Reflect_obj::field(this->properties,propertyName)))->__Field(HX_CSTRING("get_end"),true)(),true);
				}
			}
		}
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.actuators.MotionPathActuator"), hx::TCanCast< MotionPathActuator_obj> ,sStaticFields,sMemberFields,
