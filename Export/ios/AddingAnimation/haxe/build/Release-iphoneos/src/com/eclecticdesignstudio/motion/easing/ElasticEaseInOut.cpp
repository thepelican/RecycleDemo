...
{
HX_STACK_PUSH("ElasticEaseInOut::new","com/eclecticdesignstudio/motion/easing/Elastic.hx",101);
{
	HX_STACK_LINE(103)
	this->a = a;
	HX_STACK_LINE(104)
...
Float ElasticEaseInOut_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("ElasticEaseInOut::ease","com/eclecticdesignstudio/motion/easing/Elastic.hx",129);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float ElasticEaseInOut_obj::calculate( Float k){
	HX_STACK_PUSH("ElasticEaseInOut::calculate","com/eclecticdesignstudio/motion/easing/Elastic.hx",108);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(110)
	if (((k == (int)0))){
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.ElasticEaseInOut"), hx::TCanCast< ElasticEaseInOut_obj> ,sStaticFields,sMemberFields,
