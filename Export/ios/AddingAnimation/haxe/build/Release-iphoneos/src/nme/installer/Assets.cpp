...
Void Assets_obj::initialize( ){
{
		...
		if ((!(::nme::installer::Assets_obj::initialized))){
			HX_STACK_LINE(43)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/nme.png"),HX_CSTRING("assets_nme_png"));
			HX_STACK_LINE(44)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/nme.png"),HX_CSTRING("image"));
			HX_STACK_LINE(47)
