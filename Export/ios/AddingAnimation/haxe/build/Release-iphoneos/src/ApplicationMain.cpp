...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(16)
		::nme::Lib_obj::create( Dynamic(new _Function_1_2()),(int)0,(int)0,(int)30,(int)16777215,(int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0)),HX_CSTRING("Adding Animation"),null());
	}
return null();
}
